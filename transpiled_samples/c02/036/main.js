...
var fullName = document.querySelector('#fullName'); // 文字を入力する度にonKeyUp()を実行する
...
function onKeyUp() {
  // 姓
  var familyName = familyNameText.value; // 名

  var firstName = firstNameText.value; // フルネームを出力

  fullName.innerHTML = familyName + ' ' + firstName; // 次のように記述しても可
