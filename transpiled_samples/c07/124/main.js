// 吹き出し用の要素
var balloon = document.querySelector('#balloon'); // 対象の文字列要素

var paragraph = document.querySelector('.paragraph'); // 選択開始したときの処理

paragraph.addEventListener('selectstart', function () {
  // マウスを離したときの処理
  paragraph.addEventListener('mouseup', function (event) {
    // 選択されている文字列を取得する※
    var selectionCharacters = window.getSelection().toString();
...
balloon.addEventListener('click', removePopup); // 吹き出しを閉じる処理
